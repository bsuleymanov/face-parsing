...
class Deconv2d(nn.Module):
    ...
    def forward(self, fmap1, fmap2):
        ...
        fmap_cat = torch.cat([fmap2, fmap1], dim=1)
        return self.conv(fmap_cat)


class UNet(nn.Module):
    def __init__(self, feature_scale=4, n_classes=19, in_channels=3):
        ...
        self.deconv1 = Deconv2d(filters[4], filters[3])
        self.deconv2 = Deconv2d(filters[3], filters[2])
        self.deconv3 = Deconv2d(filters[2], filters[1])
    ...
    def forward(self, image):
        ...
        out = self.deconv2(down2, out)
        out = self.deconv2(down1, out)
